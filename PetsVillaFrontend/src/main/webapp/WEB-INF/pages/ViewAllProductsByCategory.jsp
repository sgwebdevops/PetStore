        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid2">
                <div class="product-image2">
                    <a href="#">
                        <img class="pic-1" src="${images}/${productObj.imgName}">
                        <img class="pic-2" src="${images}/${productObj.imgName}">
                    </a>
                    <ul class="social">
                        <!-- <li><a href="#" data-tip="Quick View"><i class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li> -->
                        <%-- <li><a href="${contextRoot}/addtoCart/${productObj.productId}" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li> --%>
                    </ul>
                    <c:choose>
                    <c:when test="${not empty status}">
                    <div style = color:red>
                    <a class="Out-of-stock">Out-of-Stock</a></div>
                   </c:when>
                   <c:otherwise>
                   <a class="add-to-cart" href="${contextRoot}/addtoCart/${productObj.productId}">Add to cart</a>
                   </c:otherwise>
                    </c:choose>
                    
                </div>
                <div class="product-content">
                    <h3 class="title"><a href="#">${productObj.productName}</a></h3>
                    <span class="price">Rs. ${productObj.productPrice}</span>
                </div>
            </div>
        </div>
